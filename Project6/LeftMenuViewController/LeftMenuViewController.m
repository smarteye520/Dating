...
- (void)viewDidLoad {
    ...
    self.tableView = ({
        UITableView *tableView = [[UITableView alloc] initWithFrame:CGRectMake(30, (self.view.frame.size.height - 40 * 7) / 2.0f+70, kWidth-60, 40 * 5) style:UITableViewStylePlain];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *titles = @[@"Matches", @"Messages", @"Profile", @"Invite",@"Settings"];
    NSArray *images = @[@"loveIcon", @"messageIcon", @"profileIcon", @"mailIcon",@"settingsIcon"];
